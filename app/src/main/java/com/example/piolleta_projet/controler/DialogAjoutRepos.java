...
import com.example.piolleta_projet.controler.DialogAjoutExercice;

public class DialogAjoutRepos extends AppCompatDialogFragment {
    private EditText editTextDuree;
    private EditText editTextLibelle;
    private DialogAjoutExercice.DialogListener listener;
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(!duree.equals("") && !libelle.equals("") && !duree.equals("0") && libelle.trim().length()>0) {
                            listener.applyTexts(duree,libelle,"Repos");
                        }
                    }
                });
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (DialogAjoutExercice.DialogListener) context;
    ...
    public interface DialogListener {
        void applyTexts(String duree, String libelle, String typeExercice);
    }
}
